...
public enum SCAPIRouter: URLRequestConvertible {
    ...
    public func asURLRequest() throws -> URLRequest {
        ...
        do {
            var encodedRequest = try? encoding.encode(request, with: result.parameters! as! Parameters)
    ...
    /*public var URLRequest: NSMutableURLRequest {
        ...
        let encoding = method == Alamofire.HTTPMethod.post ? Alamofire.ParameterEncoding.json : Alamofire.ParameterEncoding.url
